...
"""Artifact v1 action implementation"""

import json

from glareclient.common import exceptions
...
class StaticActionCall(command.ShowOne):
    """Call static method of the GlarePL class."""
    ...
    def take_action(self, parsed_args):
        ...
        client = self.app.client_manager.artifacts

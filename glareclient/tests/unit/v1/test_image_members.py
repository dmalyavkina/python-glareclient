...
import glareclient.v1.image_members
import glareclient.v1.images
...
class ImageMemberManagerTest(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.mgr = glareclient.v1.image_members.ImageMemberManager(self.api)
        self.image = glareclient.v1.images.Image(self.api, {'id': '1'}, True)
    ...
    def test_list_by_member(self):
        resource_class = glareclient.v1.image_members.ImageMember
    ...
    def test_replace_objects(self):
        body = [
            glareclient.v1.image_members.ImageMember(
